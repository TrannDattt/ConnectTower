...
#pragma target 3.0
		...
		// Khai báo lại các biến từ Properties vào code
        sampler2D _BaseMap;
        fixed4 _BaseColor;
        struct Input
        {
            float2 uv_BaseMap; // Đổi từ uv_MainTex thành uv_BaseMap cho khớp Property
        };
        void surf(Input IN, inout SurfaceOutputStandard o)
        {
            // Lấy màu từ Texture và nhân với màu Tint (_BaseColor)
